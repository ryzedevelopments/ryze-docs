...
Heists on Ryze RP must remain organized, immersive, and free from interference.
These rules ensure every group has a fair chance to run their scenario without griefing or exploitation.

## Heist Interference Restrictions

The following actions are strictly prohibited during any active heist:

Taking over, interrupting, or inserting your group into another crew’s active heist
...
Heists must remain clean, contained, and respectful of other players’ storylines.

## Heist-Approved Actions
...
## Ryze RP Heist Standard

Ryze RP expects all heists to follow:

Fair engagement

Respect for other groups’ scenarios
...
Groups that cannot maintain these standards will face disciplinary action.
